...
EVIDENCE_DIR="$EVIDENCE_DIR" KBS_URL="$KBS_URL" PROOF_SCOPE=rung-c RUNG_B_KEY_ID="$RUNG_B_KEY_ID" RUNG_B_POLICY_URI="$RUNG_B_POLICY_URI" RUNG_C_POLICY_URI="$RUNG_C_POLICY_URI" PODS="$PODS" \
