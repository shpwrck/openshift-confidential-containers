...
write_summary() {
...

	{
		...
		echo "rung_b_key_id=${RUNG_B_KEY_ID}"
		echo "rung_b_policy_uri=${RUNG_B_POLICY_URI}"
		echo "rung_c_policy_uri=${RUNG_C_POLICY_URI}"
		echo "artifact_dir=${ARTIFACT_DIR}"
		echo "evidence_dir=${EVIDENCE_DIR}"
		echo "pods=${PODS}"
		echo "rung_b_pod=${RUNG_B_POD}"
		echo "rung_c_pod=${RUNG_C_POD}"
		echo "neg_rung_b_pod=${NEG_RUNG_B_POD}"
