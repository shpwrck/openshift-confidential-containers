...
EVIDENCE_DIR="$EVIDENCE_DIR" KBS_URL="$KBS_URL" RUNG_B_KEY_ID="$RUNG_B_KEY_ID" RUNG_B_POLICY_URI="$RUNG_B_POLICY_URI" RUNG_C_POLICY_URI="$RUNG_C_POLICY_URI" PODS="$PODS" RUNG_B_POD="$RUNG_B_POD" \
	...
	TRUSTEE_LOG_TAIL="$TRUSTEE_LOG_TAIL" TRUSTEE_LOG_SINCE_TIME="$TRUSTEE_LOG_SINCE_TIME" POD_LOG_TAIL="$POD_LOG_TAIL" MIRROR_LOG_TAIL="$MIRROR_LOG_TAIL" MIRROR_LOG_SINCE_TIME="$MIRROR_LOG_SINCE_TIME" \
