...
EVIDENCE_DIR="$EVIDENCE_DIR" KBS_URL="$KBS_URL" RUNG_B_APP_LOG_MARKER="$RUNG_B_APP_LOG_MARKER" \
	RUNG_C_APP_LOG_MARKER="$RUNG_C_APP_LOG_MARKER" TRUSTEE_LOG_TAIL="$TRUSTEE_LOG_TAIL" \
	POD_LOG_TAIL="$POD_LOG_TAIL" MIRROR_LOG_TAIL="$MIRROR_LOG_TAIL" \
...
KBS_URL="$KBS_URL" RUNG_B_APP_LOG_MARKER="$RUNG_B_APP_LOG_MARKER" RUNG_C_APP_LOG_MARKER="$RUNG_C_APP_LOG_MARKER" \
