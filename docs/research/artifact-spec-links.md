...
1. **MA01 does not currently describe the local GitOps base literally.** Red Hat 1.12 says to use a
   ...
   [`KbsConfig`](../../gitops/base/trustee/kbsconfig.template.yaml) and its base
