...
<https://github.com/cri-o/cri-o/issues/10084>; even when upstream issue state changes, rung-b
completion still requires a supported direct-pull path plus passing happy/negative proof evidence.
