...
RUNG_ENCRYPTED_POD ?= rung-c-encrypted
RUNG_SIGNED_POD ?= rung-b-signed
NEG_RUNG_ENCRYPTED_POD ?= negtest-rung-c
NEG_RUNG_SIGNED_POD ?= negtest-rung-b
RUNG_SIGNED_EVIDENCE_PODS ?= $(RUNG_SIGNED_POD) $(NEG_RUNG_SIGNED_POD)
RUNG_ENCRYPTED_APP_LOG_MARKER ?= rung-c: encrypted image decrypted and running
RUNG_SIGNED_APP_LOG_MARKER ?= rung-b: signed image accepted and running
KEEP_DENIED_PODS ?= 0
